...
| 2026-06-11 | Blog 2 vía Google Doc (mismo artículo, pero por link en vez de PDF) | El agente marcaba "faltan enlaces internos = crítico" en TODOS los blogs, pero era un FALSO POSITIVO: el PDF y el export a texto plano pierden los hipervínculos. El Google Doc real tenía 7+ enlaces internos a Teilur (/pricing, /how-it-works, /insights/...). | Loader de Google Docs reescrito para exportar HTML y extraer los hipervínculos reales (desenvolviendo el redirect de Google). Se anexan al texto en una sección `=== ENLACES DETECTADOS ===`. Rúbrica actualizada para usar esa sección como fuente de verdad. Resultado: el mismo blog subió de 5.2 a 6.2 (SEO de ~4 a 6), reconociendo "sí hay CTA + enlaces internos". |
